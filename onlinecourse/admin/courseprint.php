...
<option value="onchange()">Select Course</option>
<?php 
...
<?php } 
function onchange(){
if($_POST['value'] == 'coursename'){
    // query to get all Doe records
    $query = "SELECT * FROM courseenrolls WHERE name='course'";
}
}
?>
    </select> 
...
if($_POST['value'] == 'coursename'){
    // query to get all Doe records
    $query = "SELECT * FROM courseenrolls WHERE name='coursename'";
}
